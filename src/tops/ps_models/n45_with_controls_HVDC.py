    ...
    return {
        ...
        'generators': {
            'GEN': [
                ...
                ['G3000-3', '3300',  1200.00,  0,     787.5246,   1,   6,   0,    2.42,  2,     0.23,    0.4108,  0.16,     0.16,     10.8,     1,        0.05,      0.05], #Forsmark 3
                ...
                ['G3300-1', '3300',  1100.00,  0,     787.5246,   1,   6,   0,    2.42,  2,     0.23,    0.4108,  0.16,     0.16,     10.8,     1,        0.05,      0.05], #Ringhals 3 https://world-nuclear.org/information-library/country-profiles/countries-o-s/sweden
        ...
        'pss': {
            'STAB1': [
                ...
                # ['PSS3',    'G3115-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS4',    'G3115-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS5',    'G3245-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS6',    'G3249-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS7',    'G3249-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS8',    'G5120-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS9',    'G5120-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS10',   'G5230-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS11',   'G5230-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS12',   'G5240-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS13',   'G5240-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS14',   'G5240-3',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS15',   'G5250-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS16',   'G5310-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS17',   'G5320-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS18',   'G5320-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS19',   'G5320-3',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                ['PSS20',   'G5420-1',   10,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS21',   'G5420-2',   20,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS22',   'G5420-3',   20,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS23',   'G5510-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS24',   'G5510-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS25',   'G5520-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS26',   'G5520-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS27',   'G5551-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS28',   'G5560-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                ['PSS29',   'G7000-1',   10,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS30',   'G7000-2',   20,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS31',   'G7000-3',   20,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS32',   'G7000-4',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS33',   'G7000-5',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS34',   'G7000-6',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS35',   'G7000-7',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS36',   'G7100-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS37',   'G7100-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS38',   'G3300-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS39',   'G3300-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS40',   'G3300-3',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS41',   'G3359-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS42',   'G3359-2',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS43',   'G3359-3',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS44',   'G3359-4',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS45',   'G3359-5',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                # ['PSS46',   'G8500-1',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
            ]
        },
        ...
        'vsc': {
            'VSC_SI': [
                ...
                ['WG5230-1',   '5230',    1500,      0,         0,           1,      1,        0.05,     0.05,         5,          0.1,         0.01,      1.2,        0,        0.1,       1.2],
