...
# This version includes HVDC links and wind power modeled as VSC.
...
def load():
    return {
        ...
        'loads': [
            ...
            ['L5220-1', '5220', 0, 0, 'Z'],
            ['L5230-1', '5230', 1436, 50, 'Z'], #VSC HVDC
            ['L5231-1', '5231', 1099, 50, 'Z'],
            ['L5240-1', '5240', 1099, 50, 'Z'], 
            ['L5240-2', '5240', 637, 50, 'Z'], #VSC HVDC
        ...
        'generators': {
            'GEN': [
                ...
                # ['G3359-5', '3359',  1200.00,  0,     766.3424,   1,   3,   0,    2.13,  2.03,  0.31,    0.403,   0.1937,   0.1937,   4.75,     1,        0.05,      0.05], #Disconnected as wind power is integrated in this version
        ...
        #Most of the PSS are not connected to the system as it is not required for the stability of the system
        'pss': {
            'STAB1': [
